...
//		Double [][]matrix = Matrix.getRatingsMatrix(943, 1682, 100000);
		...
		Rating_menu ratingMenu= new Rating_menu();
		Rating_menu.launch(Rating_menu.class);
		ratingMenu.setAgent(clientAgent);
...
//		
//		Double[] line= test5(0, matrix, binaryItemTaxonomyMatrix);
//
...
//		maeMetric();
	...
	// test Prediction Fusion Module
	public static void test31(int activeUser)
	{
		...
		// show TeCF predicted active user line
		for(int j= 0; j < tecfMatrix.length; j++)
		{

			if(j==0)
				System.out.print("[ ");

			System.out.print(tecfLine[j] + ", ");
...
//		Double[][] predictedUserItemRatingMatrix = new Double[supplierBuyerRatingMatrix.length][supplierBuyerRatingMatrix[0].length];
		...
		for(int j= 0; j < predictedUserItemRatingLine.length; j++)
		{
			...
			System.out.print(predictedUserItemRatingLine[j] + ", ");
...
//		}
	...
	// test Prediction Fusion Module
	public static Double[] test5(int activeUser, Double[][] supplierBuyerRatingMatrix, Double[][] binaryItemTaxonomyMatrix)
	{
...
//		}
	...
	public static void maeMetric()
	{
		...
		Double[][] binaryItemTaxonomyMatrix = Matrix.getItemTaxonomyMatrix(1682, 19);
